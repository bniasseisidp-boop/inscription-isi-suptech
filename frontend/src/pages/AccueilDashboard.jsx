...
import { getPublicStudents, verifyQR, verifyMatriculeAccueil, updateMyPassword, updateMyPhoto } from '../services/api'
          ...
          <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-md shadow-2xl p-6">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <div className="text-xs text-slate-400 mb-2">{user?.email} · Accueil</div>
