...
<div style="max-width:560px;margin:30px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
  ...
  <div style="padding:30px;">
    ...
    <p style="color:#475569;font-size:14px;text-align:center;margin:0 0 20px;">
      ...
      Votre inscription à <strong>ISI SUPTECH</strong> vient d'être enregistrée. Un compte a été créé pour vous sur votre espace étudiant.
    </p>

    <div style="background:#0a1628;color:#fff;border-radius:12px;padding:20px;text-align:center;margin-bottom:20px;">
      <div style="font-size:11px;opacity:.6;text-transform:uppercase;letter-spacing:2px;">Votre matricule étudiant</div>
      <div style="font-size:24px;font-weight:900;letter-spacing:3px;margin:8px 0;color:#60a5fa;">{{ $student->matricule ?? '—' }}</div>
    </div>
    ...
    <p style="color:#94a3b8;font-size:12px;text-align:center;margin-bottom:20px;">
      Après votre première connexion, pensez à changer ce mot de passe et à compléter votre dossier.
    </p>
