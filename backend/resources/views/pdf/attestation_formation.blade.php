...
<table class="shell"><tr>
  ...
  <td class="content">
    ...
    <div class="p indent">a suivi dans notre institut la formation en :</div>
    <div class="field">{{ $student->license?->nom ?? '—' }}</div>
    <div class="field">Spécialité : <b>{{ $student->filiere?->nom ?? '—' }}</b></div>
    <div class="field">Pour les années académiques : <b>{{ $anneesListe }}</b></div>
    <div class="p indent">et a validé tous ses modules.</div>
