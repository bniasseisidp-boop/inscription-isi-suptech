        ...
        foreach ($matched as $st) {
            ...
            $student = Student::updateOrCreate(
                ...
                [
                    ...
                    'sexe'                 => $sexe,
                    'date_naissance'       => $st['date_naissance'] ?? '2000-01-01',
                    'lieu_naissance'       => $st['lieu_naissance'] ?? 'Dakar',
                    'adresse'              => $st['adresse'] ?? 'Dakar, Sénégal',
                    'nationalite'          => $st['nationalite'] ?? 'Sénégalaise',
                    'pays_residence'       => $st['pays_residence'] ?? 'Sénégal',
